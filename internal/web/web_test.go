...
func TestPagesRender(t *testing.T) {
	...
	pages := []string{"/", "/ruleset", "/ruleset/raw", "/import", "/timeline", "/connections", "/rules", "/rules/new", "/lists", "/forwarding", "/forwarding/new", "/library", "/changes", "/advisor", "/settings", "/profile", "/api/status"}
	for _, p := range pages {
